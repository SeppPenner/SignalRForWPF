...
* **Version 1.0.9.0 (2026-08-17)** : Updated nuget packages, moved to Net 10.0, fixed the server startup (missing routing middleware and host run without await), fixed the swapped text and title in the client error message box.
